%This runs the cosmo version of the pipeline

%The following preprocessing must be done:
%   1. SAR data from: https://earth.esa.int/eogateway/documents/20142/37627/COSMO-SkyMed-Second-Generation-Mission-Products-Description.pdf
%   2. Open CosmoSkyMED image in SNAP:
        %2.1 Subset image
        %2.2 Save as .nc file
...
%% ==================== SENTINEL DATA ====================
% Import from file
filepath = "/Users/tris/Documents/MSc/data/Cosmo/subset_CSKS1_DGM_B_WR_01_VV_RA_SF_20220722070221_20220722070237_small.nc";
...
% else 
    sar_azimuth_to_north_angle = cosmo.SceneOrientationAngle;
% end

sar_dy_azimuth = cosmo.AzimuthResolution;
sar_dx_range = cosmo.RangeResolution;

% Plot the data
if sarPlotsON
    figure; plotFunctions.sarImage(1, sar_data, "Cosmo-SkyMED SAR Image - " + string(sar_start_datetime));
end
...
disp(['Buoy ERA5 Tm: ', num2str(buoy_data.Tp)]);
